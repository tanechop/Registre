...
public class Main extends JFrame {
    ...
    public Main(){
        ...
        panelprincipale.setBackground(new Color(122, 150, 236)); // ou Color.ORANGE

// 2. Rendre le panel du formulaire transparent pour laisser paraître le fond
        titre= new JLabel("<html><span style='color: #10b981; font-size: 10px; font-weight: bold;background-color:blue'>\u2713</span> FORMULAIRE D'ENREGISTREMENT</html>", SwingConstants.CENTER);
        titre.setFont(new Font("BOOK Antiqua", Font.BOLD, 25));
        titre.setForeground(new Color( 16, 185, 129)); // Optionnel : couleur du texte
...
// 3. L'ajouter en HAUT de votre panel principal
        ...
        panel.setBackground(new Color(122, 150, 236));
        panel.add(new JLabel(" Nom:",SwingConstants.CENTER){{ setFont(new Font("BOOK Antiqua", Font.BOLD, 16)); }});
        ...
        panel.add(new JLabel(" Prénom",SwingConstants.CENTER){{ setFont(new Font("BOOK Antiqua", Font.BOLD, 16)); }});
        ...
        panel.add(new JLabel(" N° CNI:",SwingConstants.CENTER){{ setFont(new Font("BOOK Antiqua", Font.BOLD, 16)); }});
        //gbc.gridx = 1; gbc.gridy = 1; gbc.weightx = 0.6;
        champ3 = new JTextField();
        panel.add(champ3);
        panel.add(new JLabel(""));

        panel.add(new JLabel(" N° Téléphone:",SwingConstants.CENTER){{ setFont(new Font("BOOK Antiqua", Font.BOLD, 16)); }});
        //gbc.gridx = 1; gbc.gridy = 1; gbc.weightx = 0.6;
        champ4 = new JTextField();
        panel.add(champ4);
        panel.add(new JLabel(""));

        panel.add(new JLabel(" Heure d'arriver:",SwingConstants.CENTER){{ setFont(new Font("BOOK Antiqua", Font.BOLD, 16)); }});
        //gbc.gridx = 1; gbc.gridy = 1; gbc.weightx = 0.6;
        ...
        panel.add(new JLabel(" Heure de dèpart:",SwingConstants.CENTER){{ setFont(new Font("BOOK Antiqua", Font.BOLD, 16)); }});
        //gbc.gridx = 1; gbc.gridy = 1; gbc.weightx = 0.6;
        champ6 = new JTextField();
        panel.add(champ6);
        panel.add(new JLabel(""));

        panel.add(new JLabel(" Motif :",SwingConstants.CENTER){{ setFont(new Font("BOOK Antiqua", Font.BOLD, 16)); }});
        //gbc.gridx = 1; gbc.gridy = 1; gbc.weightx = 0.6;
       ...
       /* bouton4=new JButton("<html><span style='color: #10b981; font-size: 10px; font-weight: bold;'>\u2713</span> </html>");
        bouton4.setPreferredSize(new Dimension(50,50));
       // bouton4.setBackground(Color.blue);
        ...
        //bouton4.setBorder(new RoundBorder(25));*/
